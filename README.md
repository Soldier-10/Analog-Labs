...
## Description
These projects and labs were solved as a self-learning procedure using EDA tools to master electronics and integrated circuit design.
...
This is the same final project of **"Analog/Mixed-Signal Simulation and Modeling Course"** of SIEMENS EDA, Egypt. (Courtesey of Dr. Omran)


A project to practice: *behavioral modeling using Verilog-A* and *top-down design methodology for a complex mixed-signal system (PLL)*.  
